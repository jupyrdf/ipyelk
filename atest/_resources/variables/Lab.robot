...
${JLAB XP DOCK TAB}    xpath://div[contains(@class, 'p-DockPanel-tabBar')]//li[contains(@class, 'p-TabBar-tab')]
...
${MENU NOTEBOOK}    xpath://div[@id="jp-contextmenu-open-with"]//div[contains(@class, 'p-Menu-itemLabel')][contains(., "otebook")]
...
${MENU EDITOR THEME}    xpath://div[contains(@class, 'p-Menu-itemLabel')][contains(text(), "Text Editor Theme")]
