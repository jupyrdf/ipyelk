...
# -*- coding: utf-8 -*-
#
# elk documentation build configuration file
#
...
_version_py = os.path.join(repo, 'elk', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'elk.tex', 'elk Documentation',
     'Dane Freeman', 'manual'),
]
