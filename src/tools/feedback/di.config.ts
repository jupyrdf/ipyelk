...
import { configureCommand,
      LocationPostprocessor, MoveCommand, TYPES,
      SelectCommand, SelectAllCommand, GetSelectionCommand,
     } from "sprotty/lib";
...
const toolFeedbackModule = new ContainerModule((bind, _unbind, isBound) => {
    bind(ToolTYPES.IFeedbackActionDispatcher).to(FeedbackActionDispatcher).inSingletonScope();
